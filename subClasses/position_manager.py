...
DEFAULT_X_SHIFTS: dict[int, int] = {
    ...
    20: +_shift5 + 20,     21: -(_shift5 + 20) - _sw,
}
...
DEFAULT_Y_VALUES: dict[int, int] = {
    ...
    16: 255,  17: 255,  18: 260,  19: 175,  20: 345,  21: 345,
}

# ─── Linkage groups ───────────────────────────────────────────────────────────
X_SHIFT_GROUPS: list[list[int]] = [
    [0], [1], [2], [3], [4], [5, 18], [6, 10], [7, 8, 9],
    [11, 15], [12, 13, 14], [16], [17], [19], [20], [21],
]

Y_GROUPS: list[list[int]] = [
    [0, 3], [1, 4], [2, 5, 18], [6, 11], [7, 12, 20, 21],
    [8, 13], [9, 14], [10, 15], [16, 17], [19],
]
